import { Shape, SiderbarItemKey, siderbarItemKeyToStTypeMap } from "@hfdraw/types";
...
export class ConnectModel {
    ...
    constructor(public projectId: string,  public edgeKey: SiderbarItemKey, public waypoint:PointDto[], public sourceShape:ShapeEntity , public targetShape: ShapeEntity) {
      }
    // 受影响的图形（增删改的图形）
